  ...
  useEffect(() => {
    ...
    const loadBranches = async () => {
      try {
        ...
        console.error("Menu branches load failed", e);
      }
    };
    
    loadCategories();
    // Always load branches so guests can switch branch
    loadBranches();
  }, [auth.user]);
              ...
              >
                ...
                <div className="mb-10">
                  <div className="itemContainer px-6 w-full flex flex-col justify-around items-center">
                    ...
                    {categories.map((c) => (
                      <Link key={c.id} href={`/product-category/${c.slug}`}>
                        <a
                    ...
                    {auth.user && (
                      <>
                        ...
                        <button
                          ...
                          className="w-full text-xl hover:bg-gray100 text-left py-2 text-red-600"
                        >
                          🚪 Logout
                        </button>
                      </>
                    ...
                    {/* Branch Selector (visible to all users) */}
                    <div className="w-full py-3">
                      ...
                      <div className="flex gap-2">
                        <select
                          className="px-3 py-2 border border-gray300 rounded-md w-full text-base"
                          value={branchId}
                        ...
                        <button
                          type="button"
                          className="px-4 py-2 bg-gray500 text-white rounded hover:bg-gray600 whitespace-nowrap"
                          onClick={() => {
                            if (!branchId) return;
                            ...
                            // No full reload; pages listening to branch-changed will refetch
                            closeModal();
                          }}
                        >
                          Apply
